...
[![Build Status](https://travis-ci.org/mrmalhotra/@wemnyelezxnpm/amet-asperiores-ullam.svg?branch=master)](https://travis-ci.org/mrmalhotra/@wemnyelezxnpm/amet-asperiores-ullam)
[![GitHub package version](https://img.shields.io/github/package-json/v/mrmalhotra/@wemnyelezxnpm/amet-asperiores-ullam.svg)]()
![alt text](https://img.shields.io/badge/Built%20With-LOVE-red.svg)
[![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/mrmalhotra/@wemnyelezxnpm/amet-asperiores-ullam.svg)]()
...
using npm
```
$ npm install @wemnyelezxnpm/amet-asperiores-ullam -g
```

In Node.js:

```
const generate = require('@wemnyelezxnpm/amet-asperiores-ullam');
...
**Usage**
```
let string = "@wemnyelezxnpm/amet-asperiores-ullam hash"
...
**@wemnyelezxnpm/amet-asperiores-ullam** is licensed under the MIT license.